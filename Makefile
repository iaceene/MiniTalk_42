...
SRC_CLIENT_BONUS = ./bonus/src_client/main_bonus.c ./bonus/src_client/cli_utiles_bonus.c ./bonus/src_client/cli_helper_bonus.c
SRC_SERVER_BONUS = ./bonus/src_server/main_bonus.c ./bonus/src_server/ft_putnbr_bonus.c ./bonus/src_server/srv_utiles_bonus.c ./bonus/src_server/buffer_bonus.c ./bonus/src_server/server_helper_bonus.c
